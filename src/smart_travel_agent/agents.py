...
CALENDAR_SYSTEM_PROMPT = (
    ...
    "search_school_calendar tool's index. First check whether the requested break "
    "constraint actually describes a school break or vacation period (e.g. 'Thanksgiving "
    "break', 'a week in March', 'winter break'). If it's clearly something else — an "
    "unrelated question, a random phrase, or anything that isn't describing a break — do "
    "not call the search tool at all. Instead, respond that you didn't understand it as a "
    "school break and ask the user to specify one, without proposing any dates.\n\n"
    "Otherwise, you must call the tool once per school, by name — "
